#!/usr/bin/env python3
"""
Iterative Deepening Water Maze Simulation - Video Frame Generator
...
import os
from iterative_deepening_water_maze import WaterMaze


class WaterMazeVideoGenerator:
    """Generates video frames for Iterative Deepening water maze simulation."""
    ...
    def generate_video(self, max_steps=None):
        ...
        if max_steps is None:
            max_steps = self.maze.width * self.maze.height * 3
        ...
        # Generate frames
        step = 0
        while step < max_steps and not self.maze.found_goal:
        ...
        print(f"  ffmpeg -r 10 -i {self.output_dir}/frame_%04d.png -c:v libx264 -pix_fmt yuv420p iterative_deepening_water_maze.mp4")


def main():
    """Main function to generate video frames."""
    print("Iterative Deepening Water Maze - Video Frame Generator")
    print("=" * 50)
