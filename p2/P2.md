...
Version 2.0. Last Updated: 11/12/2024
...
*Note:* On Mac or Linux, python may still refer to Python 2.7, though it's rarer
...
To submit your project, run `python autograder.py` on your local solution. Then
commit and push your changes to your GitHub repository. Finally, put a link to your 
repository in the assignment on Canvas.
