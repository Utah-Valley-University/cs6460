...
\pointsinrightmargin
\bracketedpoints
\printanswers % Solutions are included

% Conditional header based on whether solutions are shown
\ifprintanswers
  \header{CS 6460: Artificial Intelligence}{Problem 2 — Solution}{Fall 2025}
\else
  \header{CS 6460: Artificial Intelligence}{Problem 2}{Fall 2025}
\fi
\footer{}{}{\thepage}
...
\begin{center}
  {\Large \textbf{Problem 2: MDP and Value Iteration}}\\[6pt]
\end{center}
\vspace{1em}
...
\begin{questions}
  ...
  \begin{center}
    ...
    \captionof{figure}{Grid for Problem 2.}
  \end{center}
