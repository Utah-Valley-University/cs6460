...
\begin{questions}
  ...
  \begin{center}
    \includegraphics[width=0.6\linewidth,alt={Minimax tree for Question 1 showing nodes A (root, MAX), B and C (MIN nodes), D, E, F (MAX nodes), and leaf nodes with values 12, 15, 6, 21, 5, 10, 1, 19, and 2.}]{images/problem1_minimax_tree.png}\\
    \textbf{Figure 1:} Minimax tree for Question 1.
  \end{center}
  ...
  \begin{center}
    \includegraphics[width=0.25\linewidth,alt={Grid for Question 2 showing a 2x3 grid with states labeled A (top-left), B (top-middle), C (top-right), D (bottom-left), E (bottom-middle), and F (bottom-right, containing a food pellet).}]{images/problem2_grid.png}\\
    \textbf{Figure 2:} Grid for Question 2.
  \end{center}
